...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="nature">internship</option>
         <option value="education">education</option>
         <option value="pets and animals">opportunities</option>
         <option value="technology">technology</option>
         <option value="fashion">guidance</option>
         <option value="entertainment">entertainment</option>
         <option value="movies and animations">career</option>
         <option value="gaming">experience</option>
         ...
         <option value="food and drinks">FAANG</option>
         <option value="lifestyle">lifestyle</option>
         <option value="personal">Alumni  </option>
         <option value="health and fitness">placement</option>
         <option value="business">business</option>
         <option value="shopping">networking</option>
         <option value="animations">exposure</option>
      </select>
      <p>post image</p>

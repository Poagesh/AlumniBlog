...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p>categories</p>
         <div class="flex-box">
            <a href="category.php?category=nature" class="links">internship</a>
            ...
            <a href="category.php?category=gaming" class="links">experience</a>
            <a href="category.php?category=sports" class="links">sports</a>
            <a href="category.php?category=design" class="links">design</a>
            <a href="category.php?category=fashion" class="links">guidance</a>
            <a href="category.php?category=persional" class="links">Alumni</a>
